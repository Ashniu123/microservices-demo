...
var BookFilter = module.exports.BookFilter = function(args) {
  ...
  if (args) {
    if (args.bookIds !== undefined && args.bookIds !== null) {
      this.bookIds = Thrift.copyList(args.bookIds, [null]);
    }
    if (args.name !== undefined && args.name !== null) {
      this.name = args.name;
    }
...
BookFilter.prototype.write = function(output) {
  ...
  if (this.bookIds !== null && this.bookIds !== undefined) {
    output.writeFieldBegin('bookIds', Thrift.Type.LIST, 1);
    output.writeListBegin(Thrift.Type.STRING, this.bookIds.length);
    for (var iter7 in this.bookIds)
    {
      if (this.bookIds.hasOwnProperty(iter7))
      {
        iter7 = this.bookIds[iter7];
...
var GetBookRequest = module.exports.GetBookRequest = function(args) {
  ...
  if (args) {
    ...
    if (args.stateAt !== undefined && args.stateAt !== null) {
      this.stateAt = args.stateAt;
    }
...
GetBookRequest.prototype.write = function(output) {
  ...
  if (this.stateAt !== null && this.stateAt !== undefined) {
    output.writeFieldBegin('stateAt', Thrift.Type.STRING, 2);
    output.writeString(this.stateAt);
    output.writeFieldEnd();
  }
  ...
  if (this.skip !== null && this.skip !== undefined) {
    output.writeFieldBegin('skip', Thrift.Type.I32, 4);
  ...
  if (this.sortBy !== null && this.sortBy !== undefined) {
    output.writeFieldBegin('sortBy', Thrift.Type.I32, 6);
    output.writeI32(this.sortBy);
    output.writeFieldEnd();
  }
  if (this.sort !== null && this.sort !== undefined) {
    output.writeFieldBegin('sort', Thrift.Type.I32, 7);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem14 = null;
          elem14 = new ttypes.Book();
          elem14.read(input);
          this.books.push(elem14);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
GetBookResponse.prototype.write = function(output) {
  ...
  if (this.books !== null && this.books !== undefined) {
    ...
    for (var iter15 in this.books)
    {
      if (this.books.hasOwnProperty(iter15))
      {
        iter15 = this.books[iter15];
        iter15.write(output);
      }
    }
    output.writeListEnd();
